...
if (isset($_POST['statecode']))
{
	...
	if (empty($statecode)) // ***boş submit edilirse***
	{
		$statecode = 'ALL';
	}
} else { // ***sayfa refresh edilirse/load edilirse***
	$statecode = 'ALL';
}
...
if ($statecode != 'ALL')
{
	...
	// **remember to add single quot**
}
// ***statecode == 'ALL' ise else statement yazmamıza gerek yok
// ve o zaman tüm sonuçlar getirilir***
